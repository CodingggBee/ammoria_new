...
export default function Footer() {
  ...
  const services = [
    { href: "/services", label: "Landscaping & External Works" },
    { href: "/services", label: "Construction" },
    { href: "/services", label: "Interior & Fit-Out" },
    { href: "/services", label: "Swimming Pools & Water Features" },
  ];
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <span>AMMORIA BUILDING CONTRACTING LLC</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              ...
              <li>
                <a
                  href="mailto:ammoria@ammoria.ae"
        ...
        <div className="mt-12 border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-400">
              © {currentYear} AMMORIA BUILDING CONTRACTING LLC. All rights reserved.
            </p>
