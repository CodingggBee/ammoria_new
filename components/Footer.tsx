...
export default function Footer() {
  ...
  const services = [
    { href: "/services", label: "Building Contracting" },
    { href: "/services", label: "Road & Infrastructure" },
    { href: "/services", label: "Interior & Landscape Design" },
    { href: "/services", label: "Sustainable Design" },
        ...
        <div className="mt-12 border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-400">
              © {currentYear} Ammoria Contracting. All rights reserved.
            </p>
